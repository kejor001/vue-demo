        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl>
                <dt class="title">{{ skuChange[0].saleAttrName }}</dt>
                <dd
                  :class="{ active: item1 == currentIndex1 }"
                  @click="ddChange(item1)"
                  v-for="item1 in 3"
                >
                  {{ skuChange[0].saleAttrValueName }}
                </dd>
              </dl>
              <dl>
                <dt class="title">{{ skuChange[1].saleAttrName }}</dt>
                <dd
                  :class="{ active: item2 == currentIndex2 }"
                  @click="ddChange1(item2)"
                  v-for="item2 in 3"
                >
                  {{ skuChange[1].saleAttrValueName }}
                </dd>
              </dl>
            </div>
            <div class="cartWrap">
...
export default {
  ...
  mounted() {
    ...
    // console.log(this.$store.state.detail.goodInfo);
  },
  computed: {
  ...
  methods: {
    ddChange(item1) {
      this.currentIndex1 = item1;
    },
    ddChange1(item2) {
      this.currentIndex2 = item2;
    },
    changeSkuNum(event) {
    ...
    async addCart() {
      try {
        ...
        this.$router
          .push({ name: "addcartsuccess", query: { skuNum: this.skuNum } })
          .catch((err) => {});
      } catch (error) {
